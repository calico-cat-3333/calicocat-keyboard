...
keyboard.extensions.append(lcdlockstatus.LCDLockStatus())
...
keyboard.keymap = [[
    ...
    KC.CAPS, KC.MS_LT, KC.MS_DN, KC.MS_RT, KC.NONE, KC.NONE, KC.NONE, KC.MB_LMB, KC.MB_MMB, KC.MB_RMB, KC.NONE, KC.NONE, KC.ENT,  KC.PGUP,
    KC.LSFT, KC.NONE,  KC.NONE,  KC.NONE,  KC.NONE, KC.NONE, KC.NONE, KC.MW_DN,  KC.NONE,   KC.NONE,   KC.NONE, KC.RSFT, KC.UP,   KC.PGDN,
